 ...
 * @returns {JSX.Element} - JSX element for EditPopUp
 */
    ...
    return (
        <div className='edit-pop-up'>
            ...
            <div className='edit-pop-up-content'>
                <div
                    className={`pop-up-item${selectedMenu === "command" ? " active" : ""}`}
                    onClick={() => setSelectedMenu(`${selectedMenu === "command" ? "" : "command"}`)}
                >
                ...
                <div
                    className={`pop-up-item${selectedMenu === "regenerate" ? " active" : ""}`}
                    onClick={regenerate}
                >
                ...
                <hr />
                <div
                    className={`help-btn${selectedMenu === "help" ? " active" : ""}`}
                    onClick={() => setSelectedMenu(`${selectedMenu === "help" ? "" : "help"}`)}
                >
