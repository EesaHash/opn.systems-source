...
export const ExpandMinimisedTableItem2 = (props) => {
    ...
    return(
        <div key={props.index} className={`list-table4-list-item${props.isEditSelected(props.index) ? " active" : ""}`} onClick={expandMinimisedBtn}>
            ...
            {props.isEditSelected(props.index) && <EditPrompt/>}
        </div>
    );
};